...
docker run -e ENABLE_COMPATIBILITY_REPORTING --env-file .travis/common/travis-ci.env -v $(pwd):/home/yuzu/project -v "$HOME/.ccache":/root/.ccache quriouspixel/yuzu:20.04 /bin/bash /yuzu/.travis/appimage/docker.sh
